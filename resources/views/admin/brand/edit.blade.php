        ...
        <div class="flex justify-center items-center h-full w-full">
            <main class="border-2 p-4 border-blue-300 bg-green-50 bg-opacity-30 max-w-2xl w-full rounded-2xl">
                ...
                <div class="flex flex-col items-center gap-4 mb-8">
                    <form class="flex flex-col gap-4 w-full" action="{{route('brand.update',$brand->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="flex items-center mb-4">
                            <label class="text-sm font-bold text-gray-800">Select a Brand Icon:</label>
